...
public class MainAbilitySlice extends AbilitySlice {
    ...
    private void initComponents() {
        ...
        Component toastDialogButoon=findComponentById(ResourceTable.Id_toast_dialog);
        ...
        toastDialogButoon.setClickedListener(component -> showToast_dialog());
    }
...
//        commonDialog.setContentText("getApiVerson"+String.valueOf(SystemVersion.getApiVersion()));
        commonDialog.setContentText("getVersion"+SystemVersion.getApiVersion());
...
//                resultText.setText("getVersion" + SystemVersion.getSdkApiVersion());
//            }
            iDialog.destroy();
        });
        ...
        commonDialog.setButton(IDialog.BUTTON2, "No", (iDialog, var) -> {
            ...
            if(SystemVersion.getApiVersion()>=7){
                resultText.setText(SystemVersion.getSdkApiVersion());
            }
            iDialog.destroy();
        });
        commonDialog.show();
    ...
    private void showToast_dialog(){
        ToastDialog toastDialog=new ToastDialog(this);
        toastDialog.setText("hello world");
        toastDialog.setDuration(2*200);
        toastDialog.show();
    }
